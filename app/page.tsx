  ...
  return (
    <main>
      <nav className="nav shell">
        ...
        <div className="navlinks"><a href="#prototype">Prototype</a><a href="/modeling">Modeling</a><a href="#evidence">Data</a><a href="#next">Roadmap</a><a href="/about">About</a><a href="#get-app">Get the app</a></div>
        ...
        <div className="shell">
          ...
          <div className="demo-grid">
            <article className="patient-card">
              ...
              <small className="disclaimer">Fictional rule-based demonstration, not an output of the NHANES model. Scores and allocation counts do not establish clinical benefit.</small>
            </article>
          ...
          <EverydayPlanner key={contextMode} context={contextMode} />
        </div>
      </section>
      ...
      <section className="app-coming" id="get-app" aria-labelledby="app-heading">
        <div className="shell app-coming-grid">
          <div>
            <div className="kicker">ONQIVA MOBILE · COMING SOON</div>
            <h2 id="app-heading">Get the ONQIVA app.<br /><em>Your questions, closer at hand.</em></h2>
            <p>A companion designed to turn your questions into a practical daily guide, with a way to explore the science behind it.</p>
            <div className="app-platforms" aria-label="Planned platforms">
              <div className="app-platform"><img src="/icons/apple.svg" alt="" width="28" height="28" /><div><strong>iPhone</strong><span>Coming soon</span></div></div>
              <div className="app-platform"><img src="/icons/android.svg" alt="" width="28" height="28" /><div><strong>Android</strong><span>Coming soon</span></div></div>
            </div>
            <p className="app-status">In development. Not yet available to download. Features and release timing are still being developed.</p>
          </div>
          <div className="app-feature-list">
            <h3>What we’re planning</h3>
            <ul>
              <li><strong>A starting point that fits you</strong><span>The same three paths: cancer care, family-history questions, or general health interest.</span></li>
              <li><strong>Today, this week, next appointment</strong><span>Small educational tasks and questions organized around your answers.</span></li>
              <li><strong>Your notes in one place</strong><span>A place to organize food labels, previous lab details, and questions for your care team.</span></li>
              <li><strong>A deeper look at the evidence</strong><span>Explore the mathematics, published biology, and limits behind the research.</span></li>
            </ul>
            <a href="mailto:sciencelecturesyt@gmail.com?subject=ONQIVA%20app%20inquiry">Ask about the app →</a>
          </div>
        </div>
      </section>
